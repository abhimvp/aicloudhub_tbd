  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-[#0a0a0a] via-[#111] to-[#0a0a0a] flex items-center justify-center px-4">
      <div className="max-w-2xl mx-auto text-center">
        <BookX className="w-24 h-24 text-orange-400 mx-auto mb-8" />
        ...
        <p className="text-xl text-gray-400 mb-8">
          Sorry, we couldn't find the course you're looking for. It may have been removed or is no longer available.
        </p>
