      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            {/* <h1
              className={`text-5xl md:text-5xl lg:text-7xl font-black mb-6 ${
                actualTheme === "dark"
                  ? "bg-linear-to-r from-orange-400 via-yellow-200 to-white bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(255,165,0,0.4)]"
            ...
            >
              Global leader in IT services & corporate training
            </p> */}
          </motion.div>
        </div>
      </section>
