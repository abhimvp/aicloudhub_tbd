...
const Stats = () => {
    ...
    return (
        <section className={`relative py-20 border-y overflow-hidden ${actualTheme === 'dark'
                    ...
                    {stats.map((stat, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className={`relative group p-6 rounded-2xl border transition-all duration-300 hover:-translate-y-1 ${actualTheme === 'dark'
                            ...
                            >
                                <div className={`mb-4 inline-flex p-3 rounded-xl ${actualTheme === 'dark'
                                ...
                                <div className={`text-4xl md:text-5xl font-black mb-2 tracking-tight ${actualTheme === 'dark'
                                    ? 'bg-linear-to-r from-orange-400 to-yellow-200 bg-clip-text text-transparent'
                                    : 'text-slate-900'
                                    }`}>
                                    {stat.value}
                                </div>
                                <div className={`text-sm md:text-base font-medium ${actualTheme === 'dark' ? 'text-zinc-400' : 'text-slate-600'
                                    }`}>
                                    {stat.label}
                                </div>
                            </motion.div>
