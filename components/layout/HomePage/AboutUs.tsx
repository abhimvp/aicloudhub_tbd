    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          >
            Trusted by global enterprises for delivering innovation, agility, and measurable impact.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          >
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                <div className={`w-12 h-12 rounded-full flex items-center justify-center ${actualTheme === "dark" ? "bg-orange-500/20" : "bg-orange-100"
                  }`}>
                  <Award className={`w-6 h-6 ${actualTheme === "dark" ? "text-orange-400" : "text-orange-600"
                    }`} />
                </div>
                <h3
              ...
              >
                Our team brings years of hands-on experience in Retail, E-commerce, Telecom, and Supply Chain — enabling us to deliver context-aware, outcome-driven solutions tailored to your business.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                <div className={`w-12 h-12 rounded-full flex items-center justify-center ${actualTheme === "dark" ? "bg-purple-500/20" : "bg-purple-100"
                  }`}>
                  <Brain className={`w-6 h-6 ${actualTheme === "dark" ? "text-purple-400" : "text-purple-600"
                    }`} />
                </div>
                <h3
                  className={`text-xl font-bold ${actualTheme === "dark" ? "text-white" : "text-gray-900"
              ...
              >
                We embed AI, automation, and analytics into every layer of your digital ecosystem — helping you make faster, smarter, and more predictive decisions.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                <div className={`w-12 h-12 rounded-full flex items-center justify-center ${actualTheme === "dark" ? "bg-blue-500/20" : "bg-blue-100"
                  }`}>
                  <CloudCog className={`w-6 h-6 ${actualTheme === "dark" ? "text-blue-400" : "text-blue-600"
                    }`} />
                </div>
                <h3
                  className={`text-xl font-bold ${actualTheme === "dark" ? "text-white" : "text-gray-900"
              ...
              >
                Whether you're migrating, modernizing, or managing — we ensure your cloud environment is optimized for cost, performance, and security.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                <div className={`w-12 h-12 rounded-full flex items-center justify-center ${actualTheme === "dark" ? "bg-green-500/20" : "bg-green-100"
                  }`}>
                  <Handshake className={`w-6 h-6 ${actualTheme === "dark" ? "text-green-400" : "text-green-600"
                    }`} />
                </div>
                <h3
                  className={`text-xl font-bold ${actualTheme === "dark" ? "text-white" : "text-gray-900"
              ...
              >
                From strategy to implementation and beyond, we work as an extension of your team — ensuring long-term success, agility, and business continuity.
              </p>
            </div>
          </motion.div>
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                <div className={`w-12 h-12 rounded-full flex items-center justify-center ${actualTheme === "dark" ? "bg-orange-500/20" : "bg-orange-100"
                  ...
                  <Shield className={`w-6 h-6 ${actualTheme === "dark" ? "text-orange-400" : "text-orange-600"
                    }`} />
                </div>
                <h3
                  className={`text-xl font-bold ${actualTheme === "dark" ? "text-white" : "text-gray-900"
              ...
              >
                100% on-time delivery and proven frameworks that ensure seamless performance, scalability, and security — every single time.
              </p>
            </div>
          </motion.div>
        </div>
